...
gulp.task('profiles:clean', function() {
    const patterns = [
        ...
        },
        {
            ...
            child:  'field',
            patterns: [/.*Local$/, /FAQ.*/,/SocialPost.*/,'Contact.OtherNationalities__c','Event.PosActivityId__c','Quote__c.IsByConversion__c',/StartDateSettings__mdt.*/,'Task.PosActivityId__c']
        },
        {
            node: 'layoutAssignments',
            child:  'layout',
            patterns: [/EntityMilestone.*/, /ErrorLog.*/, /Event.*/, /FAQ__.*/, /Idea.*/, /Question.*/, /Reply.*/,/QuickText.*/,/Scorecard.*/,/CollaborationGroup-Group.*/,/SocialPost.*/,/StartDateSettings__mdt.*/]
        },
        {
            node: 'objectPermissions',
            child:  'object',
            patterns: ['ActiveScratchOrg', 'FAQ__kav', 'NamespaceRegistry', 'ScratchOrgInfo','QuickText','Scorecard','ScorecardAssociation','ScorecardMetric','StartDateSettings__mdt']
        },
        {
            node: 'pageAccesses',
            child:  'apexPage',
